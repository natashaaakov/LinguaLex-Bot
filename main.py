...
async def start_command(update: Update, context: CallbackContext):
    ...
    text = (
        "Вітаю! Я словниковий бот <b>LinguaLex Bot</b> або просто <b>Лексі</b> 💜\n"
        "\n"
        "Тут Ви можете переглянути <b>словникові статті</b>, створені на основі корпусу <b>статей BBC</b> (в онлайн версії за 2015-2019 роки) з метою вивчення лексичних одиниць англійської та української мов.\n"
        "\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text_part1 = (
        ...
        "\n"
        "Кожна словникова стаття складається з таких <b>складових частин</b>:\n"
        "🔸 ключове слово (англ.);\n"
        "🔸 частиномовна належність слова;\n"
        "🔸 частотність використання слова;\n"
        "🔸 тлумачення слова;\n"
        "🔸 приклад використання слова з корпусу;\n"
        "🔸 ключове слово (укр.);\n"
        "🔸 частиномовна належність слова;\n"
        "🔸 частотність використання слова;\n"
        "🔸 тлумачення слова;\n"
    ...
    text_part2 = (
        "На основі опрацьованого матеріалу було створено <b>245 оригінально-авторських словникових статей</b>, розподіл яких здійснено на основі повнозначних частин мови:\n"
        "🔹 <i>101 іменник;</i>\n"
        "🔹 <i>78 дієслів;</i>\n"
        "🔹 <i>28 прикметників;</i>\n"
        "🔹 <i>27 прислівників;</i>\n"
        "🔹 <i>11 займенників.</i>\n"
        "\n"
        "📌 <b>Частотність</b> кожного слова було взято з паралельних корпусів (див. нижче)\n"
        "\n"
        "📌 <b>Тлумачення англійських слів</b> було взято з <b><a href='https://dictionary.cambridge.org'>Cambridge Dictionary</a></b>\n"
        "\n"
        "📌 <b>Тлумачення українських слів</b> було взято з <b><a href='https://sum.in.ua'>Словника української мови</a></b>\n"
        "\n"
        "📌 <b>Приклад використання</b> ключового слова було взято також з паралельних корпусів (див. нижче)\n"
        "\n"
        "📌 Щоб переглянути список словникових статей, будь ласка, натисніть команду <b>/wordlist</b> (або виберіть відповідну команду у <b>Меню/Menu</b>).\n"
        "\n"
    )
    ...
    text_part3 = (
        "🟣 <b>Корпус текстів:</b>\n"
        "\n"
        "📌 Корпус текстів створено на основі оригіналів англомовних статей та їх україномовних перекладів з рубрик <b>BBC Travel</b> та <b>BBC Future</b>.\n"
        "\n"
        "📌 Кожне речення-приклад містить <b>пряме посилання на сайт статті</b>, на який можна перейти, натиснувши на нього.\n"
        "\n"
        "📌 Загальний список статей міститься за <b><a href='https://docs.google.com/spreadsheets/d/1CcfJil80hzNLY5xwSgy4h5pdrCA7XTe5DfDqmxnxQ_8/edit?usp=sharing'>посиланням</a></b>.\n"
        "\n"
        "📌 Корпус текстів було створено за допомогою програми <b><a href='https://www.laurenceanthony.net/software/antconc/'>AntConc</a></b>. Аналогічний корпус можна створити, завантаживши відповідні статті у форматі <i>.txt</i> за <b><a href='https://drive.google.com/drive/folders/1vwRNkQfSWg0zZCJ30Xnli8eB2MTgV4CM?usp=sharing'>посиланням</a></b>.\n"
        "\n"
